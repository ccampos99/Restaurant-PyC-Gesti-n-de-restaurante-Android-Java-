...
public class EditarPlatoDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (platoOriginal != null) {
            editNombre.setText(platoOriginal.getNombre());
            editPrecio.setText(String.valueOf(platoOriginal.getPrecio()));
            editDescripcion.setText(platoOriginal.getDescripcion());
            editTiempo.setText(String.valueOf(platoOriginal.getTiempoPrep()));
            spinnerCategoria.setSelection(categorias.indexOf(platoOriginal.getCategoria()));
            spinnerEstado.setSelection(estados.indexOf(platoOriginal.getEstado()));
        }
